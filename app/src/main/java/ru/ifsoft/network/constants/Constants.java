...
public interface Constants {
    ...
    public static final String SENDER_ID = "345634563456";  //GOOGLE API Sender ID

    // Google Pay settings | Settings from In-App Purchasing for Android | See documentation

    public static final String BILLING_KEY = "3245r43ff34rf34f34f34f34f";

    // Fortumo settings | Settings from In-App Purchasing for Android | See documentation

    public static final String FORTUMO_SERVICE_ID = "345ty43tg345t345t345t";     //Service ID

    public static final String FORTUMO_APP_SECRET = "345t345t435t345t345t345t";     //In-application secret

    public static final String WEB_SITE = "http://network.ifsoft.ru/";  //web site url address
