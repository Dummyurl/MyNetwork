...
public class Profile extends Application implements Constants, Parcelable {
    ...
    private int state, sex, year, month, day, verify, itemsCount, photosCount, likesCount, giftsCount, followingsCount, followersCount, allowComments, allowMessages, lastAuthorize, accountType;
